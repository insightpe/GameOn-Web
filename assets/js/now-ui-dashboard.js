...
seq = 0, delays = 80, durations = 500, seq2 = 0, delays2 = 80, durations2 = 500,
    function() {
        ...
        0 != $(".tagsinput").length && $(".tagsinput").tagsinput(), $(".bootstrap-tagsinput").addClass(e + "-badge"), 0 != $(".selectpicker").length && $(".selectpicker").selectpicker({
            ...
            var e = document.querySelector("#myModal"),
                a = document.querySelector("#noticeModal"),
                i = document.querySelector("#myModal10");
            new PerfectScrollbar(e), new PerfectScrollbar(a), new PerfectScrollbar(i)

	...
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-body">
				...
				?>
				<!-- form start -->
				<form role="form" id="frmCampo" action="<?php echo base_url('agregar-campo'); ?>" method="POST">
					<input type="hidden" value="0" id="campo_id" name="campo_id">
					<input type="hidden" value="0" id="lat" name="lat">
					<input type="hidden" value="0" id="lng" name="lng">
					<div class="box-body">
						<div class="row">
							<div class="col-xl-6">
								<div class="row">
								...
								<div class="row">
									<div class="col-xl-12">
										<div class="form-group">
											...
											<input id="external_url" type="text" class="form-control" name="external_url" placeholder="Ej.: http://www.google.com">
										</div>
									</div>
								</div>
								<div class="row">
										...
										<div class="form-group">
											...
											<select class="form-control" name="campo_distritos" id="campo_distritos">
												...
												foreach ($distritos as $distrito) {
														echo '<option value="' . $distrito->id . '">' . $distrito->name . '</option>';
												}
												?>
											</select>
										</div>
								...
								<div class="row">
									<div class="col-xl-12">
										<div class="form-group">
											...
											<textarea id="datos_adicionales" name="datos_adicionales" rows="6" class="form-control" placeholder="Datos Adicionales"></textarea>
										</div>
									</div>
								</div>
								<div class="row">
								...
								<div class="row">
										<div class="col-xl-12">
											<div class="form-group">
												...
												<input id="ubicacion" type="text" class="form-control" name="ubicacion" placeholder="Ubicación">
											</div>
										</div>
									</div>
					...
					<div class="box-footer">
						...
						<button type="button" id="btnNewCampo" class="btn btn-primary"><?php echo $this->lang->line('button_create'); ?></button>

 ...
 * @author furbox
 */
class Campoimagenes_model extends CI_Model {

    //put your code here
    private $table = "campo_imagenes";
    private $id = "campo_imagenes_id";

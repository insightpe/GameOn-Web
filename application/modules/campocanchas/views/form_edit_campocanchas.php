		...
		<div class="card">
			...
			<div class="card-body">
				...
				<form role="form" id="frmCampoCancha" action="" method="POST">
					<input type="hidden" value="<?php echo $campo_cancha->campo_cancha_id ?>" id="id" name="id">
					<div class="box-body">
						<div class="row">
							<div class="col-xl-4">
								<div class="form-group">
									<label for="nombre">Nombre</label>
									<input id="nombre" type="text" class="form-control" value="<?php echo $campo_cancha->nombre ?>" name="nombre" placeholder="Nombre">
								</div>
							</div>
							<div class="col-xl-4">
								<div class="form-group">
									...
									<?php } else { ?>
										...
										<?php
										foreach ($campos as $campo) {
											echo '<option ' . ($campo_cancha->campo_id == $campo->campo_id  ? "selected" : "") . ' value="' . $campo->campo_id . '">' . $campo->nombre . '</option>';
										}
										?>
									<?php } ?>
								...
								<div class="form-group">
									...
									<select class="form-control" name="deporte_id" id="deporte_id">
										...
										foreach ($deportes as $deporte) {
											echo '<option ' . ($campo_cancha->deporte_id == $deporte->deporte_id  ? "selected" : "") . ' value="' . $deporte->deporte_id . '">' . $deporte->nombre . '</option>';
										}
										?>
									</select>
								</div>
								...
								<div class="form-group">
									...
									<select class="form-control" name="campo_estado_id" id="campo_estado_id">
										...
										foreach ($campo_estados as $estado) {
											echo '<option ' . ($campo_cancha->campo_estado_id == $estado->campo_estado_id  ? "selected" : "") . ' value="' . $estado->campo_estado_id . '">' . $estado->nombre . '</option>';
										}
										?>
									</select>
								</div>
...
<script>
	var diahoras = <?php echo json_encode($campocanchadiahoras) ?>;
</script>
...
$config['hosts'] = array('red.cavipetrol.com'); 
$config['ports'] = array(389);
$config['basedn'] = 'OU=Usuarios,OU=Cavipetrol,DC=red,DC=cavipetrol,DC=com';
$config['login_attribute'] ='sAMAccountName';
$config['proxy_user'] = 'cavipetrol\AdmCigem';
$config['proxy_pass'] = '$Cigem2019';
$config['roles'] = array(1 => 'User',
    3 => 'Power User',
    5 => 'Administrator');
$config['member_attribute'] = 'sAMAccountName'; $config['auditlog'] ='application/logs/audit.log';
